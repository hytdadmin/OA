...
Description: DAL层 AttendanceList
*/
namespace DAL
{
	...
	public class AttendanceListDAL
	{
		...
		/// 获取一个实体
		/// </summary>
		public AttendanceList GetAttendanceListEntity(int ID)
		{
			return linqHelper.GetEntity<AttendanceList>(c => c.ID == ID);
		}
        ...
        {
            linqHelper.DeleteEntity<AttendanceList>(c => c.ID == FID);
        }
		...
		{
			return linqHelper.GetList<AttendanceList>();
		}
        ...
        public DataTable GetAttendanceListList(AttendanceListTO TO, int pageIndex, int pageSize, string orderBy, out int rowCount)
        {
            ...
            DataSet ds = SqlHelper.RunProcedure("SP_DividePage", parameters, "AttendanceListList");
