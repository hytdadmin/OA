...
public partial class CallCenter_Satisfaction : PageBase
{
    private int CID = 0;
    public int WID = 0;
    ...
    public Models.Call_Satisfaction sModel = new Models.Call_Satisfaction();
    public Models.Call_Satisfaction_Item siModel = new Models.Call_Satisfaction_Item();
    ...
    private void getDropdownList()
    {
        ...
        //工单状态
        strCallWorkBillStatusDrop = PublicMethod.getWorkBillStatusCallCategory(4, false, false, intStatus);//PublicEnum.EnumBindList_Client<PublicEnum.CallWorkBillStatus>(false, false, intStatus);
