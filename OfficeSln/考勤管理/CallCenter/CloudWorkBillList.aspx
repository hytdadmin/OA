<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CloudWorkBillList.aspx.cs" Inherits="CallCenter_CloudWorkBillList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function EditWorkBill(wid) {
            art.dialog.open('WorkBill.aspx?hf=0&wid=' + wid
            ,
            { title: '工单信息',
                // 在open()方法中，init会等待iframe加载完毕后执行
                init: function () {
        ...
        function HuifangWorkBill(wid) {
            art.dialog.open('VisitBill.aspx?hf=1&wid=' + wid
            ,
            { title: '工单信息',
                // 在open()方法中，init会等待iframe加载完毕后执行
                init: function () {
...
<body>
    ...
    <uc1:ChangeHeadImg ID="ChangeHeadImg2" runat="server" />
