...
public partial class CallCenter_CustomerErrorList : PageBase
{
    ...
    {
        ActiveProductInfoTO sto = new ActiveProductInfoTO();
        #region 条件
        ...
        BLL.ActiveProductInfoBLL bll = new BLL.ActiveProductInfoBLL();
        DataTable dt = bll.GetActiveProductInfoList(sto, pageIndex, pageSize, "", out rowCount);
        //分页
        string getUrl = "";
        ...
        string url = "CustomerErrorList.aspx?pageIndex={0}&" + getUrl.Trim('&');
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            {
                strNew = string.Format("&nbsp;&nbsp;<a href=\"#\" name=\"WorkBill\" tid=\"{0}\" onclick=\"showErrorInfo(this)\" >查看</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"#\" name=\"WorkBill\" onclick=\"NewWorkBill({1})\" >新建</a>", dr["ID"], dr["CC_ID"]);
                ...
                sbContent.AppendFormat("<td class=\"num\" title=\"{0}\">{0}&nbsp;</td>", dr["ErrorCode"].ToString());
