<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VisitBillList.aspx.cs" Inherits="CallCenter_VisitBillList" %>
    ...
    <script type="text/javascript">
        ...
        function NewWorkBill(cid) {
            ...
            { title: '工单信息',
                ...
                cancel: function () { parent.location.reload(); }
                ...
                <table class="tblog" style="float: left; margin-left: 10px;">
                    ...
                    <tr>
                        ...
                        <td class="tblogtd">
                            我的客户：</td>
                        <td class="tblogtd_c">
                            <input type="text" name="txtOwnerName" id="txtOwnerName" style="width: 122px" 
                                value="" /></td>
                    </tr>
                    <tr>
                        <td class="style1">
