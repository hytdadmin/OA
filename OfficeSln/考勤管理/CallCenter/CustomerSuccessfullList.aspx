<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerSuccessfullList.aspx.cs" Inherits="CallCenter_CustomerSuccessfullList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function searchWorkBill() {
            var url = "CustomerSuccessfullList.aspx";
            var urlE = "?1=1";
