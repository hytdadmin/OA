...
<head>
    ...
    <link id="ctl00_linkDefault" type="text/css" rel="stylesheet" href="myd/NewDefault.css">
    ...
    var text1 = request.getParameter("appID");
    alert(request.getParameter("appID"));
        ...
        function submitInfo() {
            ...
            + intServiceAttitude + "$$" + strServiceUserCode + "$$" + strImprovement + "$$" + IP + "$$" + CustomerID;
 ...
 var qsData = {'option':"myd",'info':info}; 
 $.getJSON("http://oa.hyitech.com/CallCenter/CallCenter.ashx", { option: "myd", info: info1 }, function (data) {
          //回调函数中对返回值进行一系列操作
　　　　   alet(data);
　　});
...
//$.ajax({
//   async:false,
//   url: http://oa.hyitech.com/CallCenter/CallCenter.ashx,
//   type: "GET",
//   dataType: 'jsonp',
//   jsonp: 'jsoncallback',
//   data: qsData,
                        ...
                        <div id="ctl00_ContentPlaceHolder1_JQ1_divHead" class="surveyhead" style="border: 0px;">
                            ...
                            <div id="ctl00_ContentPlaceHolder1_JQ1_divDec" class="surveydescription">
                                <span id="ctl00_ContentPlaceHolder1_JQ1_lblQuestionnaireDescription" style="vertical-align: middle;">
                                    亲爱的朋友您好，我们是乳制品行业的市场工作人员。感谢您在百忙之中抽空完成此问卷，帮助我们了解消费者对于高端牛奶产品的认知及购买习惯。本问卷填写一律不记名，您的个人信息会得到保密，并仅作内部使用，请放心填答。<br>
                                    ...
                                    <div class="div_question" id="div7">
                                        <div class="div_title_question_all">
                                            ...
                                            <div id="divTitle7" class="div_title_question">
                                                您认为“有机奶”的标准是？<span style="color: red;">&nbsp;*</span><span class="qtypetip">&nbsp;[多选题]</span></div>
                                            <div style="clear: both;">
                                            </div>
                                        </div>
                                        <div class="div_table_radio_question" id="divquestion7">
                                            ...
                                            <ul class="ulradiocheck">
                                                <li>
                                                    <input id="q7_1" name="q7" value="1" type="checkbox"><label for="q7_1">源自优质牧场，精选水源牧草</label></li><li>
                                                        <input id="q7_2" name="q7" value="2" type="checkbox"><label for="q7_2">生产加工全程0污染0添加</label></li><li>
                                                            <input id="q7_3" name="q7" value="3" type="checkbox"><label for="q7_3">优质乳蛋白含量≥3.5克/100克</label></li><li>
                                                                <input id="q7_4" name="q7" value="4" type="checkbox"><label for="q7_4">完善的质量跟踪审查体系</label></li><li>
                                                                    <input id="q7_5" name="q7" value="5" type="checkbox"><label for="q7_5">通过权威机构的有机品质认证</label></li><li>
                                                                        <input id="q7_6" name="q7" value="6" type="checkbox"><label for="q7_6">和普通牛奶没有什么区别，只是一个噱头</label></li><li
                                                                            style="">
                                                                            <input id="q7_7" name="q7" value="7" type="checkbox"><label style="display: inline-block;"
                                                                                for="q7_7">其他</label>
                                                                            <input style="color: rgb(153, 153, 153); position: static;" class="underline" value="请注明..."
                                                                                onpropertychange="lengthChange(this);" oninput="lengthChange(this);" rel="q7_7"
                                                                                type="text"></li><div style="clear: both;">
                                                                                </div>
                                            </ul>
                                            <div style="clear: both;">
                                            </div>
                                    ...
                                    <div class="div_question" id="div8">
                                        <div class="div_title_question_all">
                                            ...
                                            <div id="divTitle8" class="div_title_question">
                                                “有机奶”在您眼中意味着？<span style="color: red;">&nbsp;*</span><span class="qtypetip">&nbsp;[请选择<b>2</b>项]</span></div>
                                            <div style="clear: both;">
                                            </div>
                                        </div>
                                        <div class="div_table_radio_question" id="divquestion8">
                                            ...
                                            <ul class="ulradiocheck">
                                                <li>
                                                    <input id="q8_1" name="q8" value="1" type="checkbox"><label for="q8_1">更安全</label></li><li>
                                                        <input id="q8_2" name="q8" value="2" type="checkbox"><label for="q8_2">更健康</label></li><li>
                                                            <input id="q8_3" name="q8" value="3" type="checkbox"><label for="q8_3">更天然</label></li><li>
                                                                <input id="q8_4" name="q8" value="4" type="checkbox"><label for="q8_4">营养价值更高</label></li><li>
                                                                    <input id="q8_5" name="q8" value="5" type="checkbox"><label for="q8_5">口感更好</label></li><div
                                                                        style="clear: both;">
                                                                    </div>
                                            </ul>
                                            <div style="clear: both;">
                                            ...
                                            <td>
                                                <div id="divPreviewQ" style="display: none;">
                                                    <div style="margin: 30px auto; text-align: center;">
                                                        <a id="hrefPQ" target="_blank" onclick='alert("您的答卷还没有提交，请预览答卷后返回此页面并点击“提交按钮”提交答卷！");PDF_close();return true;'
                                                            class="btnbg"><span>成功生成预览，点击查看</span></a></div>
                                                </div>
                                            </td>
                                            <td align="right">
                                                <span id="spanTest" style="visibility: hidden;">&nbsp;&nbsp;<input style="font-weight: bold;"
                                                    class="operation" value="试填问卷" id="submittest_button" title="只有发布者才能看到试填按钮，试填的答卷不会参与结果统计！"
                                                    type="button"><a title="只有发布者才能看到试填按钮，试填的答卷不会参与结果统计！" style="color: green" href="javascript:void(0);"><b>(?)</b></a>&nbsp;&nbsp;<span
                                                        style="color: #ff3300;"></span></span>
                                            </td>
