<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DownloadCenter.aspx.cs" Inherits="Work_DownloadCenter" %>
...
<head runat="server">
    ...
    <script src="Scripts/DownloadCenters.js" type="text/javascript"></script>
    ...
    <div class="W_main">
        ...
        <div class="W_main_right">
            ...
            <div class="divSay">
                    ...
                    <!--右侧中间导航-->
                    <div class="right_nav">
                        <uc5:NavigateUC ID="NavigateUC1" runat="server" Defaultvalue="DownloadCenter" />
