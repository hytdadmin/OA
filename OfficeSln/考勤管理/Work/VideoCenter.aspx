<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VideoCenter.aspx.cs" Inherits="Work_VideoCenter" %>
...
<head id="Head1" runat="server">
    ...
    <script src="Scripts/flowplayer-3.2.13.min.js" type="text/javascript"></script>
    <script src="Scripts/VideoCenters.js" type="text/javascript"></script>

    <title>办公资料下载中心</title>
...
<body>
    ...
    <div id="divload" style="top:70%; right:30%;position:absolute; padding:0px; margin:0px; z-index:999">
        <img src="Scripts/jqueryPager/spinner3-greenie.gif" /></div>
    ...
    <div class="W_main">
        ...
        <div class="W_main_right">
            ...
            <div class="divSay">
                    ...
                    <!--右侧中间导航-->
                    <div class="right_nav">
                        <uc5:NavigateUC ID="NavigateUC1" runat="server" Defaultvalue="VideoCenter" />
                        <%--<div class="right_nav_search">
                            ...
                            <a href="javascript:InitDataDown(0);"><img src="Images/nav_search.jpg" /></a>
     ...
     <!-- 遮罩层 -->
     <div id="bg" onclick='javascript:hidediv()'></div>
     <div id="show" style="height:500px;width:750px;">
