<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SayList.aspx.cs" Inherits="Work_SayList" %>
...
<head runat="server">
    ...
    <script src="scripts/Says.js" type="text/javascript"></script>
            ...
            <div class="divSay">
                    ...
                    <div class="right_nav">
                        ...
                        <div class="right_nav_search">
                            ...
                            <a href='javascript:InitDataSay(0, $(".depB").attr("id"));'><img src="Images/nav_search.jpg" /></a>
                        </div>
                    </div>
                    <div class="clear">
                    </div>
