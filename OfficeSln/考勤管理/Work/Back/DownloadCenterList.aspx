<%@ Page Title="下载中心管理" Language="C#" MasterPageFile="~/Work/Back/MasterPage.master" AutoEventWireup="true" CodeFile="DownloadCenterList.aspx.cs" Inherits="Work_Back_DownloadCenterList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <ul class="transaction_search" style="padding-left: 10px;width: 755px;">
       ...
       <div style="float:right;padding-right: 10px;"><asp:Button runat="server" ID="btnSearch" CssClass="cancel" Text="搜索" 
            ...
            <input type="button" class="cancel" id="btnAdd" onclick='location.href = "EditDownloadCenter.aspx"' value="添加文件"/>
                ...
                <tr class="even" style="display: <%#bool.Parse((Repeater1.Items.Count==0).ToString())?"table-row":"none"%>;">
                    ...
                    <ItemTemplate>
                        <tr class='<%#(Container.ItemIndex%2==0)?"even":"odd"%>'>
                            ...
                            <td align="center">
                            <div>
                            <li style="float:left;width:29px;"><a href='EditDownloadCenter.aspx?id=<%#Eval("id") %>' class="buttonLink">修改</a>&nbsp;</li>
